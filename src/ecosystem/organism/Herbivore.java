...
public class Herbivore extends Animal {
    ...
    private static int visionRange = 4; // Phạm vi tầm nhìn của động vật ăn thịt
    private static double energyGainPercentage = 0.1; // Phần trăm năng lượng thu được khi ăn động vật ăn cỏ
    private static int energyThresholdForReproduction = 150; // Ngưỡng năng lượng để sinh sản
    private static int energyDecay = 3; // Năng lượng mất đi nếu không tìm thấy con mồi
    ...
    public static void setEnergyGainPercentage(double energyGainPercentage) {
        Herbivore.energyGainPercentage = energyGainPercentage;
    }
